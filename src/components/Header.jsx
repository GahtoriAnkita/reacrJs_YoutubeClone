    ...
    <>
      <div className='sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black'>
        ...
        <div className="flex h-5 items-center">
          {pageName === "video" && (
            <div className="flex md:hidden md:mr-6 cursor-pointer items-center justify-center h-10 w-0 rounded-full hover:bg-[#303030]/[0.6]" onclick={mobileMenuToggle}>
              {mobileMenu ? (
        ...
        <div className="flex items-center">
          <div className="hidden md:flex">
            ...
            <div className="flex  h-8 w-8 overflow-hidden rounded-full md:ml-4">
             <img src="https://xsgames.co/randomusers/assets/avatars/female/63.jpg" alt="female_img" />
            </div>
          </div>
        </div>
      </div>
